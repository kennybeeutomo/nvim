...
set({"n", "v"}, "ga", vim.lsp.buf.code_action, { desc = "LSP: Code Action" })
set({"n", "v"}, "<C-F>", function()
	vim.lsp.buf.format()
	vim.cmd("norm ")
end, { desc = "LSP: Format" })
set("n", "<leader>td", function() vim.diagnostic.enable(not vim.diagnostic.is_enabled()) end, { desc = "LSP: Toggle Diagnostics" })
